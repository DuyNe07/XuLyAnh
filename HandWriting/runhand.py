...
def handwriting_streamlit_show():
    result_path = ".\\Handwriting\\data\\result\\"
    classes_path = ".\\Handwriting\\data\\words_alpha.txt"
    ...
    if uploaded_file is not None:
        ...
        if "image" in uploaded_file.type:
            ...
            with st.status("Regconize HandWriting Start!", expanded=True) as status:
                ...
                result = subprocess.run(["python", "./Handwriting/detect.py", "--image", dest_path, "--scale", scale, "--margin", margin,
